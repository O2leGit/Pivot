...
const NAV_BY_ROLE: Record<PortalRole, NavItem[]> = {
  tenant: [
    ...
    { id: "features", label: "Features & Guide", icon: <Icon path="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01" /> },
  ],
  owner: [
  ...
  admin: [
    ...
    { id: "features", label: "Features & Guide", icon: <Icon path="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /> },
  ],
};
...
export default function Sidebar({ role, user, currentPage, onNavigate, onLogout }: SidebarProps) {
  ...
  return (
    ...
    >
      {/* Logo header */}
      <div className="border-b border-navy-700 flex items-center" style={{ minHeight: "56px" }}>
        {expanded ? (
          <div className="flex items-center gap-2.5 px-3 py-2 w-full overflow-hidden">
            ...
            <div className="overflow-hidden min-w-0">
              <div className="text-sm font-bold text-white leading-tight truncate">Pivot</div>
